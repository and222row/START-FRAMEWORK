...
export default function Contact() {
  return (
    <>
      <div className="text-center flex justify-center items-center mt-28">
      ...
      <form className="max-w-lg mx-auto p-4 mt-12 mb-6">
        ...
        <button
          type="submit"
          className="text-white bg-[#1abc9c]  font-medium rounded-lg text-lg w-full sm:w-auto px-5 py-2.5 text-center"
        >
          send Message
        </button>
      </form>
